seedid,fgorbg,blockordif = 4585,"fg","yes"   --  --write seed id , like if lgrid seed write 5667 and if item block write fg if item background write bg
worlds = {"x"}   --write ur worlds , you can add more world like this "worldname","worldname2"
JoinWorldWithID,worldsdoorid = "false","x"
worldwhile = "false"  -- set true for loop, false for No loop
joinstop,autoban = "false","false"

itemname ="gems_pack"     --packname like ssp_10_pack --gems_pack safe gems
packgems = 12000              --pack gems
packitemid = {242}  --pack item id like world lock 242
dropitems = "false"
amount = 3600    ---200 or 4000

weebhook= "mm"
YourDiscordid= "mm"

owner ="mm"
droppedworld,droppedworldid = "mm","mm"
seeddropworld,seeddropworldid = "mm","mm"

botneme,botpassword = "botname","botpass"   --botname and pasword
...
function powershell(loglars)
  local script = [[
    ...
    $thumbUrl = 'https://c.tenor.com/a1EUl3klXWcAAAAS/growtopia-video-game.gif' 
    ...
    $payload = [PSCustomObject]@{
      ...
      'avatar_url' = 'https://cdn.eso.org/images/screen/eso1838a.jpg'
      'username' = 'BotYangMuliaZex'
      'content' = '<@]].. YourDiscordid ..[[>'
      embeds = $embedArray
...
function main(bekleme)
  for i=1, bekleme do
    ...
    local function coptrashs(itemid)
      local trashList = {5040,5042,5044,5032,5034,5036,5038,5024,5026,5028,5030,5042,7162,7164,7058,3870,1098,1096,1094,1058,7058}
      if itemid ~= nil then
...
function botstarts()
  ...
  if worldwhile == "false" then
    ...
    sleep(5000)
    powershell("The worlds are over, the bot has been removed")
  end
end
...
function pshell(x)
  ...
  elseif file("C:\\Users\\" .. username .. "\\AppData\\Local\\false.txt") then
      ...
      powershell("This account name Does not match the one in the botlist. If you think something is wrong contact with creator. https://discord.gg/2Y7Cdpu5Dw")
  end
